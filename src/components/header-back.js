...
function Header({ siteTitle }) {
  ...
  return (
    <nav className="flex items-center p-6 mb-6 bg-white">
      ...
      <div className="block lg:hidden">
        <button
          ...
          className="flex items-center px-3 py-2 text-gray-700 border border-gray-700 rounded hover:text-white hover:border-white"
        >
          <svg
      ...
      >
        <div className="text-sm lg:flex-grow">
          <Link
            ...
            className="block mt-4 mr-4 text-gray-700 lg:inline-block lg:mt-0 hover:text-gray-400"
          >
            Home
          </Link>
          <Link
