    ...
    <section className="bg-white py-12 px-6 md:px-12 rounded-2xl shadow-xl border border-gray-100 my-12 max-w-5xl mx-auto relative overflow-hidden">
      ...
      >
        ...
        <div className="flex flex-col">
          <label htmlFor="name" className="mb-2 font-bold text-sm text-brand-black uppercase tracking-wide">
            Nombre completo
          </label>
          <input 
            type="text" 
        ...
        {/* Phone Input */}
        <div className="flex flex-col">
          <label htmlFor="phone" className="mb-2 font-bold text-sm text-brand-black uppercase tracking-wide">
            Teléfono
          </label>
          <input 
            type="tel" 
        ...
        <div className="flex flex-col md:col-span-2">
            <label htmlFor="interest" className="mb-2 font-bold text-sm text-brand-black uppercase tracking-wide">
              Estoy interesado en...
            </label>
        ...
        {/* Message Input */}
        <div className="flex flex-col md:col-span-2">
          <label htmlFor="message" className="mb-2 font-bold text-sm text-brand-black uppercase tracking-wide">
            Mensaje (Opcional)
          </label>
          <textarea 
            id="message" 
        ...
        <div className="md:col-span-2 text-center mt-6">
          <button 
            type="submit" 
            className="w-full md:w-auto bg-brand-orange text-white font-extrabold py-4 px-12 rounded-lg hover:bg-brand-black hover:text-white transition transform hover:-translate-y-1 shadow-lg text-lg uppercase tracking-wider"
          >
            Enviar Solicitud
          </button>
